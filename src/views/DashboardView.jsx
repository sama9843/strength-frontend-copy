...
export default function DashboardView({ blockingCallback, errorCallback }) {
  return (
    <main className="p-4">
      <h1 className="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl xl:text-6xl text-center">Fitness Dashboard</h1>
      <div className="grid gap-4 lg:grid-cols-2 content-normal mb-4">
        <div className="bg-orange-100 border border-orange-500 rounded-xl p-6 text-center">
          <h2 className="text-3xl xl:text-4xl font-bold mb-6">🔥 Trending Now</h2>
          <Words />
        </div>
      ...
      <div className="bg-gray-100 border border-gray-500 rounded-xl p-6 text-center">
