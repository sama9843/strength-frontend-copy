...
function SubmitButton({ name, submitting }) {
  return submitting ? (
    <button className="inline-flex flex-row items-center shadow bg-red-500 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-not-allowed" type="submit" disabled>
...
export default function Form() {
  ...
  function handleSubmit(event) {
    ...
    setTimeout(() => {
      setSubmitting(false);
      setResponse(event.target.message.value);
    }, 3000)
  }
